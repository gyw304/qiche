...
MyGame.MyLotto.prototype = {
    create: function() {
        ...
        this.totalScore = this.add.text(game.world.width/2,370,user.myLotto.name,{ font: "bold 42px Microsoft YaHei", fill: "#5b3716", align: "center" });
        this.totalScore.anchor.set(0.5,0);
        //this.totalScore.lineSpacing = 20;
        
        this.developer = this.add.text(game.world.width/2,550,user.myLotto.developer,{ font: "bold 50px Microsoft YaHei", fill: "#5b3716", align: "center" });
        this.developer.anchor.set(0.5,0);
        
        this.awardTime = this.add.text(game.world.width/2,680,'领奖时间\n'+user.myLotto.awardTime,{ font: "42px Microsoft YaHei", fill: "#5b3716", align: "center" });
        this.awardTime.anchor.set(0.5,0);
        this.awardTime.lineSpacing = 10;
        
        this.awardAddress = this.add.text(game.world.width/2,860,'领奖地址\n'+this.insertFlg(user.myLotto.awardAddress,'\n',12),{ font: "42px Microsoft YaHei", fill: "#5b3716", align: "center" });
