...
MyGame.Preloader.prototype = {
    ...
    start:function(){
    	...
    	{
    		this.load.image('lou_'+i+'',build[i].skin);
    	}
    	
    	for(var i=0;i<=KFSAD.length-1;i++)
    	{
    		this.load.image('AD_330_125'+i+'',KFSAD[i].AD_330_125);
    		this.load.image('AD_205_75_'+i+'',KFSAD[i].AD_205_75)
    		//this.load.image('lou_'+i+'',build[i].skin);
    	}
